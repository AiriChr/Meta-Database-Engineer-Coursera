...
-- Task 4: Use the HAVING clause to filter the grouped data in the subquery that you wrote in task 3 
-- to filter the 20% OrderTotal values to only retrieve values that are more than $100.
SELECT EmployeeID,HandlingCost 
FROM employee_orders  
